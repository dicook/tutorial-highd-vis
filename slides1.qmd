...
footer: "[https://dicook.github.io/tutorial-highd-vis/](https://dicook.github.io/tutorial-highd-vis/)"
---
...
::: {.f70}
This is a [basic tour]{.orange2}, which will run in your plot window. (If this doesn't show, you can create a special plot window on OSX using `quartz()` or on Windows `X11()`.)
:::
