# Tutorial: Visualising High-dimensional Data with R 

Website: [https://dicook.github.io/tutorial-highd-vis](https://dicook.github.io/tutorial-highd-vis)
...
|25|	Basics of linear projections, and recognising high-d structure|
|20|	Effectively reducing your data dimension, in association with non-linear dimension reduction|
...
1. You should have a reasonably up to date version of R and R Studio. Install the following packages, and their dependencies.
